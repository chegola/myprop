...
import com.myprop.domain.PersistentToken;
...
import com.myprop.web.rest.dto.KeyAndPasswordDTO;
        ...
        return userRepository
            ...
            .map(u -> {
                userService.updateUserInformation(userDTO.getFirstName(), userDTO.getLastName(), userDTO.getEmail(),
                    userDTO.getLangKey(), userDTO.isSubscribed());
    ...
    public void invalidateSession(@PathVariable String series) throws UnsupportedEncodingException {
        ...
        userRepository.findOneByLogin(SecurityUtils.getCurrentUserLogin()).ifPresent(u -> {
            persistentTokenRepository.findByUser(u).stream()
                .filter(persistentToken -> org.apache.commons.lang3.StringUtils.equals(persistentToken.getSeries(), decodedSeries))
