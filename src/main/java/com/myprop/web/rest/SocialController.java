...
import com.myprop.service.SocialService;
...
public class SocialController {
    ...
    public RedirectView signUp(WebRequest webRequest, @CookieValue(name = "NG_TRANSLATE_LANG_KEY", required = false, defaultValue = "\"th\"") String langKey) {
        try {
